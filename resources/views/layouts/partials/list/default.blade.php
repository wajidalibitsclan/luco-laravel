            ...
            <div class="excerpt">
                <div class="date">
                    ...
                    @if($article->type != 'scuola')
                        <span class="dd">{{$article->data_di_pubblicazione->day}} </span><span class="mm">{{$mesi[$article->data_di_pubblicazione->month -1]}} </span>
                    @endif
                    <span class="yy">{{$article->data_di_pubblicazione->year}}</span>
                </div>
